...
RSpec.describe User, type: :model do
  ...
  describe "search" do
    ...
    let!(:alice) {create(:user, firstname: 'Alice', hruid:'alice.alabama.2000', email:'alice@hotmail.com')}
    let!(:bob) {create(:user, firstname: 'Bob', hruid:'bob.beacon.2001', email:'bob@hotmail.com')}
    let!(:charlie) {create(:user, firstname: 'Charlie', hruid:'charlie.chaplin.2001', email:'charlie@hotmail.com')}
