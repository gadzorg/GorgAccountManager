Feature: Password recovery - Find a user
  ...
  Scenario: Blaked is trying to recover its password
    ...
    And he fills "Entre ici ton identifiant OU email OU n° de sociétaire..." with "blaked@gadz.org"
  ...
  Scenario: Blaked try to recover its account with the wrong email address
    ...
    And field "Entre ici ton identifiant OU email OU n° de sociétaire..." is filled with "blacked@gadz.org"